bus_2020_csv<-read.csv(file="D:/project/compare_2020_bus.csv",header=TRUE)
bus_2020_df<-data.frame(bus_2020_csv[,-c(2,3,4,5,6,55)])

bus_2019_csv<-read.csv(file="D:/project/compare_2019_bus.csv",header=TRUE)
...
subway_csv<-read.csv(file="D:/project/compare_subway.csv",header=TRUE)
...
car_csv<-subway_csv<-read.csv(file="D:/project/compare_car.csv",header=TRUE)
...
labels<-c("bus","subway","car")
cols<-c("blue","red","green")
pchs<-c(19,19,19,19)


plot(c(1:24),mydata$bus,xlab="Month",ylab="Passenger",axes=F,ylim=c(500,2000),type="o",lty=1,pch=19,main="Compare Bus, Subway, Car",col="blue",cex=1.5)
par(new=T)
plot(c(1:24),mydata$sub,xlab="Month",ylab="Passenger",axes=F,ylim=c(500,2000),type="o",lty=1,pch=19,col="red",cex=1.5)
par(new=T)
plot(c(1:24),mydata$car,xlab="Month",ylab="Passenger",axes=F,ylim=c(500,2000),type="o",lty=1,pch=19,col="green",cex=1.5)

axis(1,at=1:24,lab=month)
axis(2,at=seq(500,2000,by=100))
legend("topright",legend=labels,col=cols,pch=pchs,cex=1.2)
...
legend("topright",legend=labels2,col=cols2,pch=pchs2,cex=1.2)
